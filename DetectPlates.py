...
def detectPlatesInScene(imgOriginalScene):
    ...
    print(imgOriginalScene.shape)
    print(imgOriginalScene.shape[0])  # height of the img
    print(imgOriginalScene.shape[1])  # width of the img
    ...
    for listOfMatchingChars in listOfListsOfMatchingCharsInScene:  # for each group of matching chars
        possiblePlate = extractPlate(imgOriginalScene, listOfMatchingChars,imgThreshScene)  # attempt to extract plate
...
def extractPlate(imgOriginal, listOfMatchingChars,imgThreshScene):
    ...
    fltPlateCenterY = (listOfMatchingChars[0].intCenterY + listOfMatchingChars[
        len(listOfMatchingChars) - 1].intCenterY) / 2.1
